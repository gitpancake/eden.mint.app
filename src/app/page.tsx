...
import { MiniAppWallet } from "./auction/components/MiniAppWallet";
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="md:hidden flex justify-between items-center mb-6 border-b border-black pb-6">
          ...
          <div className="ml-auto">{typeof window !== "undefined" && (window as any).farcaster?.miniapp ? <MiniAppWallet /> : <WalletConnect />}</div>
        </div>
